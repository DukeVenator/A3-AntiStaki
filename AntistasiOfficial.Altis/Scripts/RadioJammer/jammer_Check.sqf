...
if (typeof _jammer == "Land_DataTerminal_01_F") then //check if the object Zeus placed is a Data Terminal aka Jammer
	{
		...
		[[_jammer]] execVM "Scripts\RadioJammer\TFARjamRadios.sqf";//activate Rebel's radio Jamming script, ALL CREDIT TO HIM FOR THIS, I MADE 0 EDITS TO HIS WORK
		...
		[_jammer,["Shutdown Jammer","Scripts\RadioJammer\jammer_shutdown.sqf",[_jammer,_jamSource],1,false,true,"","_this distance _target < 3"]] remoteExec ["addAction",0];
